...
import '../../styles/tutor/TutorMessenger.css';

function TutorMessenger() {
  return (
    <div>
      <Row className="g-0 tutorMessengerPageMain">
        ...
        <Col md={10} lg={10} xl={10} className="userMainPanel">
          ...
          <div className="tutorMessengerPageMessenger">
