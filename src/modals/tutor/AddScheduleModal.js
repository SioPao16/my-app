...
function TutorSchedulePageModalForAddSchedule(AddScheduleProp) {
  ...
  return (
    <Modal {...AddScheduleProp} aria-labelledby="contained-modal-title-vcenter">
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          <h3 className="tutorSchedulePageHeadersTitle">Add Schedule</h3>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body className="show-grid">
        <div className="g-0">
          <form onSubmit={handleSubmit}>
            ...
            <h5 className="tutorSchedulePageAddScheduleTitle">What do you want to teach:</h5>
            <select className="tutorSchedulePageAddScheduleSubjectDropdown">
            ...
            <h4 className="tutorSchedulePageAddScheduleScheduleTitle">Select your preffered date and time of tutorial</h4>

            {/* Comment: Date Picker */}
            <h5 className="tutorSchedulePageAddScheduleTitle">Date</h5>
            <DatePicker
            ...
            {/* Comment: Time Picker */}
            <h5 className="tutorSchedulePageAddScheduleTitle">Time</h5>

            {/* Comment: Start Time */}
            <div className="tutorSchedulePageAddScheduleStartTime">
              <h6 className="tutorSchedulePageAddScheduleTimeTitle" >Start:</h6>
              <DatePicker
            ...
            {/* Comment: End Time */}
            <div className="tutorSchedulePageAddScheduleEndTime">
              <h6 className="tutorSchedulePageAddScheduleTimeTitle" >End:</h6>
              <DatePicker
                placeholderText="Click to select a time"
            ...
            <Row className="g-0" style={{ justifyContent: 'center' }}>
              <button type="submit" className="tutorAddSchedulePageFooterButton" ><b>Add Schedule</b></button>
            </Row>
          </form>
        </div>
      </Modal.Body>
...
export default TutorSchedulePageModalForAddSchedule;